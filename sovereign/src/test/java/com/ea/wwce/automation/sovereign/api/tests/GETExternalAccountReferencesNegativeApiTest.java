...
public class GETExternalAccountReferencesNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETExternalAccountReferencesNegativeApiTest.class);
	DataProviders assertionProvider;

	@BeforeMethod
	public void beforeMethod(ITestContext context) {
		context.setAttribute("API_KEY", "EXTERNAL_ACCOUNT_REFERENCES");
	...
	public void verifyGETExternalAccountReferencesNegativeApiTest(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "43770";
