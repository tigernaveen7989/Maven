...
public class GETResetCustomerPasswordNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETResetCustomerPasswordNegativeApiTest.class);
