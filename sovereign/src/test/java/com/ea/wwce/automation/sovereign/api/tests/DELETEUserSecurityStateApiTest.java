...
public class DELETEUserSecurityStateApiTest extends SovereignAPIBaseTest {
	...
	public void verifyDeletionOfUserSecurityState(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "49662";
		...
		// Verify assertions
		assertTrue(base.getResponseData().contains(assertions.get("status").toString()),"Verify addressId is as expected");
