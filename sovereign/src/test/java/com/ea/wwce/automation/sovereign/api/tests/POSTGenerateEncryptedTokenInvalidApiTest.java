...
public class POSTGenerateEncryptedTokenInvalidApiTest extends SovereignAPIBaseTest{
	...
	public void verifyPostGenerateEncryptedTokenTest(ITestContext context) {
		...
		assertTrue(base.getResponseData().contains(assertions.get("sourceMessage").toString()),	"Verify email is as expected");
