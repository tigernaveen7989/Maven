...
public class GETAddressByAddressIdNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETAddressByAddressIdNegativeApiTest.class);
