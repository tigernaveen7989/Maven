...
public class GETNucleusUserDetailsByBESLUserIdNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETNucleusUserDetailsByBESLUserIdNegativeApiTest.class);
