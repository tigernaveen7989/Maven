...
public class GETUserStatusesSetNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETUserStatusesSetNegativeApiTest.class);
	...
	public void verifyUserStatusSetAPI(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "49306";
