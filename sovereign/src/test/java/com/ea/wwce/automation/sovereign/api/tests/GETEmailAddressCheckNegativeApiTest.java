...
public class GETEmailAddressCheckNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETEmailAddressCheckNegativeApiTest.class);
	...
	public void verifyGETEmailAddressCheckApiTest(ITestContext context) {
		...
		assertTrue(base.getResponseData().contains(assertions.get("errorCode").toString()),	"Verify expected status value is present");
		assertTrue(base.getResponseData().contains(assertions.get("errorShortMessage").toString()),	"Verify isEmailAvailable value is false");
