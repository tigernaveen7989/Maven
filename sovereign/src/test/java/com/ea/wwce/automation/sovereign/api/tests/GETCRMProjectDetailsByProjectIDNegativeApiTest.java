...
public class GETCRMProjectDetailsByProjectIDNegativeApiTest extends SovereignAPIBaseTest {
	...
	public void verifyGetCRMProjectsByProjectIDAPI(ITestContext context) {
		...
		assertTrue(base.getResponseData().contains(assertions.get("sourceMessage").toString()),	"Verify sourceMessage is as expected");
