...
public class GETSecondaryEmailCodeNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETSecondaryEmailCodeNegativeApiTest.class);
