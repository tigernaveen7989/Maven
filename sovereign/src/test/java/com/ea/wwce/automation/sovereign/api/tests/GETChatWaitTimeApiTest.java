...
public class GETChatWaitTimeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETChatWaitTimeApiTest.class);
	...
	public void verifyChatTimeWaitTimeAPI(ITestContext context) {
		...
		assertTrue(base.getResponseData().contains(assertions.get("skillUnit").toString()),
				"Verify expected skillUnit value is present");
		assertTrue(base.getResponseData().contains(assertions.get("skillLocale").toString()),
				"Verify expected skillLocale value is present");
		assertTrue(base.getResponseData().contains(assertions.get("skillDescription").toString()),
				"Verify expected skillDescription value is present");
