...
public class GETEmailAddressCheckWithRegisterEmailApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETEmailAddressCheckWithRegisterEmailApiTest.class);
	...
	public void verifyGETEmailAddressCheckWithRegisterEmailApiTest(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "43774";
		...
		assertTrue(base.getResponseData().contains(assertions.get("isEmailAvailable").toString()),"Verify isEmailAvailable value is true");
