...
public class PUTSecondaryEmailInvalidApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(PUTSecondaryEmailInvalidApiTest.class);
