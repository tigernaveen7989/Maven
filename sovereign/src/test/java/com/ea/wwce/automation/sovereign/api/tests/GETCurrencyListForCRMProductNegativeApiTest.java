...
public class GETCurrencyListForCRMProductNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETCurrencyListForCRMProductNegativeApiTest.class);
