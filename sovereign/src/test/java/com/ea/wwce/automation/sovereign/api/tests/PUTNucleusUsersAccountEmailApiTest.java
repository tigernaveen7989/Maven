...
public class PUTNucleusUsersAccountEmailApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(PUTNucleusUsersAccountEmailApiTest.class);
