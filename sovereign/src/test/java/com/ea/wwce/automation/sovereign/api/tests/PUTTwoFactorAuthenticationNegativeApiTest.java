...
public class PUTTwoFactorAuthenticationNegativeApiTest extends SovereignAPIBaseTest{
	...
	public void beforeMethod(ITestContext context) {
		context.setAttribute("API_KEY", "PUT_TWO_FACTOR_AUTHENTICATION");
		super.beforeMethod(context);
		assertionProvider = new DataProviders(context.getAttribute("assertion_path").toString());
	}

	@Test(description = "verify Update Two-Factor Authentication Status API", groups = { "Sanity" })
	@Description("verify Update Two-Factor Authentication Status API")
	public void verifyUpdateTwoFactorAuthenticationTest(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "49815";
