...
public class GETChatEstimatedWaitTimeNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETChatEstimatedWaitTimeNegativeApiTest.class);
	...
	public void verifyChatTimeWaitTimeAPI(ITestContext context) {
		...
		assertTrue(base.getResponseData().contains(assertions.get("errorShortMessage").toString()),
				"Verify errorShort Message value is present");
		assertTrue(base.getResponseData().contains(assertions.get("errorMessage").toString()),
				"Verify error Message value is present");
