...
public class GETPhoneWaitTimeNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETPhoneWaitTimeNegativeApiTest.class);
	...
	@Test(description = "verify invalid phone Wait Time API", groups = { "Sanity" })
	@Description("Verification of phone Wait time API")
	public void verifyChatTimeWaitTimeAPI(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "43463";
		...
		assertTrue(base.getResponseData().contains(assertions.get("errorShortMessage").toString()),
				"Verify errorShort Message is as expected");
		assertTrue(base.getResponseData().contains(assertions.get("errorMessage").toString()),
				"Verify error Message is as exepected");
		assertAll();
	}
