...
public class DeleteSecondaryEmailApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(DeleteSecondaryEmailApiTest.class);
	...
	public void verifyDeleteSecondaryEmailApiTest(ITestContext context) {

		// Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "49834";
