...
public class GETNucleasAccountBasicDetailsNegativeApiTest extends SovereignAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETNucleasAccountBasicDetailsNegativeApiTest.class);
