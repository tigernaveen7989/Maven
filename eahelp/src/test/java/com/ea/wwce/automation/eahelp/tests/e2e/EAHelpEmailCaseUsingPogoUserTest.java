...
public class EAHelpEmailCaseUsingPogoUserTest extends EAHelpBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseUsingPogoUserTest.class);

	@Test(description = "Verify the creation of Email case for ENGLISH locale using pogo user", groups = { "Regression",
			"Sanity" })
	@Description("Create email case for EN locale with pogo user")
