...
public class EAHelpUnAuthEmailCaseForRULocaleTest extends EAHelpBaseTest {

	@Test(description = "Create un auth email case for RU locale", groups = { "Regression", "Sanity" })
