...
public class EAHelpUnAuthEmailCaseForDELocaleTest extends EAHelpBaseTest {

	@Test(description = "Create un auth email case for DE locale", groups = { "Regression", "Sanity" })
