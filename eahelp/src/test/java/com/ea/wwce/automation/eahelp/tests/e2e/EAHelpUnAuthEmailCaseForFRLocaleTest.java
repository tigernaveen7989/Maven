...
public class EAHelpUnAuthEmailCaseForFRLocaleTest extends EAHelpBaseTest {

	@Test(description = "Create un auth email case for fr locale", groups = { "Regression", "Sanity" })
