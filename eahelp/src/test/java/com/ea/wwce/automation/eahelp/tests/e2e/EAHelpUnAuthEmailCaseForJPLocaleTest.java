...
public class EAHelpUnAuthEmailCaseForJPLocaleTest extends EAHelpBaseTest {

	@Test(description = "Create un auth email case for jp locale", groups = { "Regression", "Sanity" })
	...
	public void createUnAuthEmailCase(ITestContext context) throws InterruptedException {
		...
		// load EAHELP
		eaHelpLoginPage.loadEAHelp(context.getAttribute("BASE_SERVICE_URL").toString().replace("en", "jp"));
