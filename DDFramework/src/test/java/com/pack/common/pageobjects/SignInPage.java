...
public class SignInPage {
	...
	public void enterPassword(String password) throws Exception {
		WebElement passwordTxtBox = driver.findElement(By.name(globalfunctions.getObjectRepository().getProperty("Gmail_SignInPage_Password_Edit_box")));
	...
	public void clickOnNext() throws Exception {
		WebElement NextBtn = driver.findElement(By.className(globalfunctions.getObjectRepository().getProperty("Gmail_SignInPage_Password_Next_Button")));
