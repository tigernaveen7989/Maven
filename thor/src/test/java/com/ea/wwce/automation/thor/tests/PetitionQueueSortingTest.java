...
public class PetitionQueueSortingTest extends ThorBaseTest {

	public static Logger logger = Logger.getLogger(PetitionQueueSortingTest.class);
	@Test(description = "Thor 472 - Verify that adviser is able to sort the petitions(ASC/DSC order) in Queued and completed tabs using Subject, Category, Target persona id, Product, Case Created.",groups={"regression"})
	@Description("Verify Petition Queue Sorting")
	public void verifyQueueSorting(ITestContext context) {
		...
		logger.info("validating Petition Queue Sorting Test" + testID);
		...
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(6);
		...
		thorPetitionPage.clickOnColumnSortAscButton(4);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(6);
		...
		thorPetitionPage.clickOnColumnSortAscButton(1);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(2);
		Collections.reverse(columnValuesList);
		...
		thorPetitionPage.clickOnColumnSortDescButton(1);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(2);
		...
		thorPetitionPage.clickOnColumnSortAscButton(2);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(3);
		Collections.reverse(columnValuesList);
		...
		thorPetitionPage.clickOnColumnSortDescButton(2);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(3);
		...
		thorPetitionPage.clickOnColumnSortAscButton(3);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(5);
		Collections.reverse(columnValuesList);
		...
		thorPetitionPage.clickOnColumnSortDescButton(3);
		columnValuesList=thorPetitionPage.getQueueTableColumnValuesInList(5);
