...
public class MajorStrikesTest extends ThorBaseTest {

	public static Logger logger = Logger.getLogger(MajorStrikesTest.class);
	@Test(description = "Thor 490 - Verify that Advisor takes Add Major Strike on the target account events gets logged",groups={"Regression"})
	@Description("Verify Add Major Strike to Target Account functionality")
	public void AddMajorStrikeToTargetAccount(ITestContext context) throws InterruptedException {

		Map<String, Object> testData = new HashMap<String, Object>();
		String testID;

		//Provide the ID of the test case. This is the ID generated in the TestRail when the manual test case is created.
		testID = "16285,3068,20575";
		context.setAttribute("testcase_id", testID);
		logger.info("validating Add Major strike to Target Account" + testID);
		...
		Assert.assertTrue(intNewMajorStrikeNo==(intExistingMajorStrikeNo+1),"Major Strike not added to the Account");
		}
		assertAll();
