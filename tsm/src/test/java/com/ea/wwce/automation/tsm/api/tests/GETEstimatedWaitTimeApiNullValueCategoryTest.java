...
public class GETEstimatedWaitTimeApiNullValueCategoryTest extends TSMAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETEstimatedWaitTimeApiNullValueCategoryTest.class);
	...
	public void verifyChatTimeWaitNullValueCategoryAPI(ITestContext context) {

		// Map the test ID to the automation result for automated updated in
		// TestRail
		String testCaseID = "35502";
