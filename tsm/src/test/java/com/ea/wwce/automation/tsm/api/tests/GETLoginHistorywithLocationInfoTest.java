...
public class GETLoginHistorywithLocationInfoTest extends TSMAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETLoginHistorywithLocationInfoTest.class);
	...
	@Test(description = "Verify Get Login History with location info API with empty ID", groups = { "Sanity" })
	@Description("Verify Get Login History with location info API with empty ID")

	public void verifyChatTimeWaitAPI(ITestContext context) {
		// Map the test ID to the automation result for automated updated in
		// TestRail
		String testCaseID = "54527";
