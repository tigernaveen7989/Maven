...
public class GETEstimatedWaitTimeApiNullValueProductTest extends TSMAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETEstimatedWaitTimeApiNullValueProductTest.class);
	...
	@Test(description = "verify error message when poduct is empty", groups = { "Sanity" })
	@Description("verify error message when poduct is empty")

	public void verifyChatTimeWaitNullValueProductAPI(ITestContext context) {

		// Map the test ID to the automation result for automated updated in
		// TestRail
		String testCaseID = "35500";
