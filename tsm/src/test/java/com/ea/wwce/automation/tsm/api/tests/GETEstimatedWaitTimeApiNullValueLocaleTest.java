...
public class GETEstimatedWaitTimeApiNullValueLocaleTest extends TSMAPIBaseTest {

	public static Logger logger = Logger.getLogger(GETEstimatedWaitTimeApiNullValueLocaleTest.class);
	...
	public void verifyChatTimeWaitNullValueLocaleAPI(ITestContext context){		
		
		//Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "35504";
