...
public class OpportunityImgUploadTest3 extends GcnBaseTest{
	public static Logger logger=Logger.getLogger(OpportunityImgUploadTest3.class);
	...
	public void verifyOppImgUpload(ITestContext context) throws AWTException, InterruptedException {
		...
		this.driverInstance.getDriver().navigate().refresh();
