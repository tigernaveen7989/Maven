...
public class POSTCreatePaymentSettingsById_Inv_GcID_Test extends GcnAPIBaseTest{
	
	public static Logger logger = Logger.getLogger(POSTCreatePaymentSettingsById_Inv_GcID_Test.class);
	...
	@Test(description ="verify Create Payment Settings By Id with Invalid GC ID",groups={"regression"})
	@Description("Verification of POST Create Payment Settings By Id with Invalid GC ID")
	public void verifyCeatePaymentSettingsById_Inv_GcId(ITestContext context){	
		
		//Map the test ID to the automation result for automated updated in TestRail
		String testCaseID = "20352";
