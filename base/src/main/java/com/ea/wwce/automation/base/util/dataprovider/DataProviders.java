package com.ea.wwce.automation.base.util.dataprovider;

import com.ea.wwce.automation.base.config.BaseDataConstants;
import com.ea.wwce.automation.base.enums.TestDataType;
...
public void setApiId(String apiId) {
  ...
  /**
   * Method to read attribute data from external JSON file and pass on to the Attribute Resource object.
   * 
   * @return
   */
  public  Map<String,Object> getTestData(String testID,String...dataType ) {
    ...
    try{
        ...
        if (!fileLoader.isArray(jsonContent)){
	      ...
	      //If the value associated with attributes key contains an array of attribute objects to be created
	      ...
	      if( globalData.keySet().size() >0){
	          ...
	          while(keyIter.hasNext()){
	        	  ...
	        	  //Append global data to test data only if specific key does not exist in testdata. Test specific data always take
	        	  //precedence
