package com.ea.wwce.automation.base.util.jsonhandlers;
...
public class JsonMerger {
    ...
    public static void main(String[] args) throws JsonObjectExtensionConflictException {
    	JsonFileProcessor jfpGlobal=new JsonFileProcessor("C:\\Users\\svenkatram\\Desktop\\global.json");
    	String globalFileContent = jfpGlobal.getFileOutput();
    	JsonObject globalJsonContent=jfpGlobal.getContentAsJsonObject(globalFileContent);
    	
    	JsonFileProcessor jfpTest=new JsonFileProcessor("C:\\Users\\svenkatram\\Desktop\\test.json");
    	String testFileContent = jfpTest.getFileOutput();
    	
    	JsonObject testJsonContent=jfpTest.getContentAsJsonObject(testFileContent);
    	mergeJsonObject(globalJsonContent,
    			testJsonContent, ConflictStrategy.PREFER_SECOND_OBJ);
    	System.out.println(globalJsonContent.toString());
	}
