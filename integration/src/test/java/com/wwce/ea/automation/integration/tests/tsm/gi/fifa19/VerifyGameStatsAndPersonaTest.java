 ...
 * 
 * @author rgandham
 * @description This Test is to Verify game Stats and persona for fifa 19
 * 
 */
public class VerifyGameStatsAndPersonaTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verfiy Game Stats and Persona for fifa 19", groups = { "Regression", "Sanity" })
	@Description("Verfiy Game Stats and Persona for fifa 19")
	public void verifyGameStatsAndPersonaTest(ITestContext context) throws InterruptedException {
		...
		testID = "28109, 28111, 28790";
		context.setAttribute("testcase_id", testID);
		logger.info("Verfiy Game Stats and Persona " + testID);
