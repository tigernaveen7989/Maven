...
public class CreateUnAuthPhoneCaseForHKLocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth phone case for HK locale", groups = { "Regression", "Sanity" })
	...
	public void verifyUnAuthUserNotRedirectedToLoginPage(ITestContext context) throws InterruptedException {
		 ...
		 * 
		 * // Select sub category
		 * eaHelpCaseInformationPage.selectSubCategory(testData.get("subcategory").
		 * toString());
		 * 
