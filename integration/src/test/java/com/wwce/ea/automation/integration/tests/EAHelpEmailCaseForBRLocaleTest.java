...
public class EAHelpEmailCaseForBRLocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case Brazilian Portuguese (pt-br)locale", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify the creation of Email case for Brazilian Portuguese (pt-br)locale")
