...
public class CreatePhoneCaseForARLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForARLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for ar(Arabic) locale", groups = { "Regression", "Sanity",
			"Production_Phone_5.30PM" })
	@Description("Create phone case for ar(Arabic) locale")
