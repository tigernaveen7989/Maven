...
public class CreateChatCaseUsingClubPogoUserTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseUsingClubPogoUserTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for ENGLISH locale using club pogo user ", groups = { "Regression",
			"Sanity" })
	@Description("Create chat case for ENGLISH locale using club pogo user")
