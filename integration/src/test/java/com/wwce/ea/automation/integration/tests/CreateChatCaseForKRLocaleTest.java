...
public class CreateChatCaseForKRLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForKRLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for Korean (ko-ko) locale ", groups = { "Regression", "Sanity" })
	@Description("Create chat case for Korean (ko-ko) locale")
