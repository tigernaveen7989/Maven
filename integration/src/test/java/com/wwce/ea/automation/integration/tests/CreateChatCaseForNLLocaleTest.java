...
public class CreateChatCaseForNLLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForNLLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for NEDERLAND locale ", groups = { "Regression", "Sanity" })
	@Description("Create chat case for NEDERLAND locale")
