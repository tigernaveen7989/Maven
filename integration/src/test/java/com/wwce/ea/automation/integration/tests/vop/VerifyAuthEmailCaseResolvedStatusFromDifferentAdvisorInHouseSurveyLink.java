...
public class VerifyAuthEmailCaseResolvedStatusFromDifferentAdvisorInHouseSurveyLink extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Resolved Status From Different Advisor In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Resolved Status From Different Advisor In House Survey")
	public void VerifyAuthEmailResolvedStatusFromDifferentAdvisorInHouseSurveyCaseTest(ITestContext context) throws InterruptedException {
