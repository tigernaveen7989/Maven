 ...
 *
 */
public class VerifyAuthChatCaseAndEscalateInHouseSurveyCaseTest extends VOPIntegrationBaseTest {

	@Test(description = "validate Escalate and InHouse Survey when Customer click on End Chat link.", groups = {
			"Regression", "Sanity" })
	@Description("Validate Escalate and InHouse Survey when Customer click on End Chat link.")
