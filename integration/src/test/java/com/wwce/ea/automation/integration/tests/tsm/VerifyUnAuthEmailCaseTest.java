 ...
 * 
 * @author rgandham
 * @description This Test is to create UnAuth Email case in EAHelp and verify
 *              Casenumber.
 * 
 */
...
public class VerifyUnAuthEmailCaseTest extends TSMIntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VerifyUnAuthEmailCaseTest.class);

	@Test(description = "Create unauth Email case", groups = { "Regression", "Sanity" })
	@Description("Create unauth Email case")
	public void verifyUnAuthEmailCase(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify UnAuth Email case Test" + testID);
