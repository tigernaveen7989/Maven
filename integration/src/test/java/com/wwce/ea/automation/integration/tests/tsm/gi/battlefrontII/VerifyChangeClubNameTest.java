 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Change Club name for Battle front II
 * 
 */
public class VerifyChangeClubNameTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verify Change Club Name for Battle front II", groups = { "Regression", "Sanity" })
	@Description("Verify Change Club Name for Battle front II")
	public void verifyChangeClubNameTest(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify Change Club Name for Battle front II: " + testID);
