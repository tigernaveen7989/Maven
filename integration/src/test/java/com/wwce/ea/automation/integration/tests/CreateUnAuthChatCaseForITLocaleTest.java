...
public class CreateUnAuthChatCaseForITLocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth chat case for IT locale", groups = { "Regression", "Sanity" })
