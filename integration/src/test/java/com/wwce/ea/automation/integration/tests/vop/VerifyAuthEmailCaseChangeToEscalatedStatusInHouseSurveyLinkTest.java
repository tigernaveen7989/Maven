...
public class VerifyAuthEmailCaseChangeToEscalatedStatusInHouseSurveyLinkTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Case Change To Escalated Status In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Case Change To Escalated Status In House Survey")
	public void VerifyAuthEmailCaseChangeToEscalatedStatusInhouseSurveyCaseTest(ITestContext context) throws InterruptedException {
