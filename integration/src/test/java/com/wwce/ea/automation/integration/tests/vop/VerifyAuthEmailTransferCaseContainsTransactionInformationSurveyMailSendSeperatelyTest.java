 ...
 * reset password
 * transfer the case to other queue
...
public class VerifyAuthEmailTransferCaseContainsTransactionInformationSurveyMailSendSeperatelyTest extends VOPIntegrationBaseTest{

	@Test(description = "Verify The Auth Email Transfer Case Contains Transaction Information Sent To Player Survey Email Send Seperately", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Transfer Case Contains Transaction Information Sent To Player Survey Email Send Seperately")
	public void VerifyAuthEmailTransferCaseContainsTransactionInformationSurveyMailSendSeperatelyTest(ITestContext context) throws InterruptedException {
