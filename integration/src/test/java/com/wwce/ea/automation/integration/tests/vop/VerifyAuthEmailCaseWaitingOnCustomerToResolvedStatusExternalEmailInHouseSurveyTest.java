...
public class VerifyAuthEmailCaseWaitingOnCustomerToResolvedStatusExternalEmailInHouseSurveyTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Case Waiting On Customer To Resolved Status In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Case Waiting On Customer To Resolved Status In House Survey")
	public void VerifyAuthEmailCaseWaitingOnCustomerToResolvedStatusExternalEmailInHouseSurveyTest(ITestContext context) throws InterruptedException {
