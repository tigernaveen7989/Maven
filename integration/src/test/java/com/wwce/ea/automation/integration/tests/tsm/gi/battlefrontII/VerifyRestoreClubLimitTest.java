 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Restore clublimit for battle front II
 * 
 */
public class VerifyRestoreClubLimitTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verify Restore Club Limit for battle front II ", groups = { "Regression", "Sanity" })
	@Description("Verify Restore Club Limit for battle front II")
	public void verifyRestoreClubLimitTest(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify Restore Club Limit for battle front II: " + testID);
