 ...
 *              sent from player and Advisor with ASCII Characters.
 * 
 */

public class VerifyAuthSendandReceiveChatMessageASCIITest extends TSMIntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VerifyAuthSendandReceiveChatMessageASCIITest.class);
