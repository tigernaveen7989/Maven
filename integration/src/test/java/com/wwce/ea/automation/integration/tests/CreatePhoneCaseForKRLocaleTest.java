...
public class CreatePhoneCaseForKRLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForKRLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for Korean (ko-ko) locale", groups = { "Regression", "Sanity",
			"Production_Phone_5.30PM" })
	@Description("Create phone case for Korean (ko-ko) locale")
