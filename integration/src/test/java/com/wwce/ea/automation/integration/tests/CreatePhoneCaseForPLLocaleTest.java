...
/**
 * 
 * @author sadabala Create phone case for pl(POLAND) locale
 */

public class CreatePhoneCaseForPLLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForPLLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for pl(POLAND) locale", groups = { "Regression", "Sanity",
			"Production_Phone_3.30PM" })
	@Description("Create phone case for pl(POLAND) locale")
	public void verifyGetCallOptionIsEnabled(ITestContext context) throws InterruptedException {
		...
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "pl"));
		...
		// Verify get call option enabled
