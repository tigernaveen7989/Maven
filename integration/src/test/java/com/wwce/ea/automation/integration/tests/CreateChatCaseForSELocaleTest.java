...
public class CreateChatCaseForSELocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForSELocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for SVERIGE locale ", groups = { "Regression", "Sanity",
			"Production_Chat_3.30PM" })
	@Description("Create chat case for SVERIGE locale")
