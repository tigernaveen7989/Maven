...
public class VerifyUnAuthEmailCaseUpdatedByCustomerToResolvedStatusExternalEmailInHouseSurveyTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify Un Auth Email Case Updated By Customer To Resolved Status In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify Un Auth Email Case Updated By Customer To Resolved Status In House Survey")
	public void VerifyUnAuthEmailCaseUpdatedByCustomerToResolvedStatusExternalEmailInHouseSurveyTest(ITestContext context) throws InterruptedException {
		...
		assertTrue(
				eahelpSurveyPage.isInHouseSurveySubmitted(testData.get("InHouseSurveyText").toString()),
				"Survey completed");
