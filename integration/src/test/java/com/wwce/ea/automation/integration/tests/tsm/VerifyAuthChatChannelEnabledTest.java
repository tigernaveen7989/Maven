 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Auth Chat channel Enabled EAHelp in ICR Page.
 *              
 */

public class VerifyAuthChatChannelEnabledTest extends TSMIntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VerifyAuthChatChannelEnabledTest.class);
	
	@Test(description = "Verify AuthChat channel Available", groups = { "Regression", "Sanity" })
	@Description("Verify AuthChat channel Available")
	public void verifyAuthChatchannel(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify AuthChat channel Available" + testID);
		...
		assertTrue(eaHelpChannelSelectionPage.verifyChannelButtonIsEnabled(testData, CaseType.chat),
