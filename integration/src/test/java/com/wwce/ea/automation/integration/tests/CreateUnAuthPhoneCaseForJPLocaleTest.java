...
public class CreateUnAuthPhoneCaseForJPLocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth phone case for JP Locale", groups = { "Regression", "Sanity" })
