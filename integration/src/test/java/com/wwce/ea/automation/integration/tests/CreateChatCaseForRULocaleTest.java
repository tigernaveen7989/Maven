...
public class CreateChatCaseForRULocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForRULocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for Russian locale ", groups = { "Regression", "Sanity" })
	@Description("Create chat case for Russian locale")
