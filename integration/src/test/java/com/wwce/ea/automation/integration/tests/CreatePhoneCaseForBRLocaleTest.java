...
/**
 * 
 * @author sadabala Create phone case for ar(Arabic) locale
 */

public class CreatePhoneCaseForBRLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForBRLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for Brazilian Portuguese (pt-br) locale", groups = { "Regression",
			"Sanity", "Production_Phone_7.30PM"})
	@Description("Create phone case for Brazilian Portuguese (pt-br) locale")
