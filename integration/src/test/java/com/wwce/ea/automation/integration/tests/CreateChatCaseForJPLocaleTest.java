...
public class CreateChatCaseForJPLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForJPLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for Japanese locale ", groups = { "Regression", "Sanity" })
	@Description("Create chat case for Japanese locale")
	public void verifyChatCaseTestScenarios(ITestContext context) throws InterruptedException {
		...
		context.setAttribute("OMEGA", this.driver);
