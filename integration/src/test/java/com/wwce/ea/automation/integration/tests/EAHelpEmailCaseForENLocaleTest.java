...
public class EAHelpEmailCaseForENLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForENLocaleTest.class);

	@Test(description = "Verify the creation of Email case for ENGLISH locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for EN locale")
	public void verifyEmailCaseCreation(ITestContext context) {
		...
		try {
			...
			testID = "40419,40141,40150,40151";
			...
			logger.warn("Not able to create a  case number" + e.getMessage());
		}
