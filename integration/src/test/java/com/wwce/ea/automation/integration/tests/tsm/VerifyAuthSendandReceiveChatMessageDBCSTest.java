 ...
 *              sent from player and Advisor with DBCS Characters.
 * 
 */

public class VerifyAuthSendandReceiveChatMessageDBCSTest extends TSMIntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VerifyAuthSendandReceiveChatMessageDBCSTest.class);
	...
	public void verifyAuthSendandReceiveChatMessage(ITestContext context) throws InterruptedException {
		...
		String playerchatMessage = tsmChatPage.verifyMessagefromPlayer().toString().trim();
		...
		String advisorchatMessage = tsmeahelpChannelSelectionPage.verifyMessagefromAdvisor().toString().trim();
