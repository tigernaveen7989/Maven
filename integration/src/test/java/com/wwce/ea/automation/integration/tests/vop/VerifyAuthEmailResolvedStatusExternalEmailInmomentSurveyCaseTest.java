...
public class VerifyAuthEmailResolvedStatusExternalEmailInmomentSurveyCaseTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email In Moment Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email In Moment Survey")
