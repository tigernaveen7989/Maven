...
public class CreateChatCaseForHKLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForHKLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for Chinese locale ", groups = { "Regression", "Sanity"})
	@Description("Create chat case for Chinese locale")
