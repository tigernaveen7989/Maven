...
/**
 * This class is to create email case for • Chinese locale
 * 
 * @author sadabala
 *
 */

public class EAHelpEmailCaseForHKLocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case for Chinese  locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Verify the creation of Email case for Chinese  locale")
