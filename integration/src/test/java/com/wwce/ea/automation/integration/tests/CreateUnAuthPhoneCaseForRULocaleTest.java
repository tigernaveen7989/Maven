...
public class CreateUnAuthPhoneCaseForRULocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth phone case for RU Locale", groups = { "Regression", "Sanity" })
	...
	public void verifyUnAuthUserNotRedirectedToLoginPage(ITestContext context) throws InterruptedException {
		...
		eaHelpUnAuthCaseInformationPage.submitUnAuthLoginForm(testData.get("Email").toString());
