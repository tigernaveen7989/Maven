...
public class CreatePhoneCaseUsingPogoUserTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseUsingPogoUserTest.class);
