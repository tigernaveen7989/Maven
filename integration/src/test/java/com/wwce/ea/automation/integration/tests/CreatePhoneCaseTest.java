...
public class CreatePhoneCaseTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for ENGLISH locale ", groups = { "Regression", "Sanity","Production_Phone_3.30PM"})
