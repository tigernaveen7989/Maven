...
/**
 * 
 * @author sadabala Create phone case for HK(Chinese) locale
 */

public class CreatePhoneCaseForHKLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForHKLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for HK(Chinese) locale", groups = { "Regression", "Sanity" })
	@Description("Create phone case for HK(Chinese) locale")
