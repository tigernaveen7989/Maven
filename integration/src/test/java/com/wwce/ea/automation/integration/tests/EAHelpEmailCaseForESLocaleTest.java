...
/**
 * 
 * @author sadabala Create email case for Spanish
 */

public class EAHelpEmailCaseForESLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForESLocaleTest.class);

	@Test(description = "Verify the creation of Email case for Spanish Locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for Spanish Locale")
	public void verifyEmailCaseCreation(ITestContext context) throws InterruptedException {
		...
		// load EAHELP
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "es"));
