...
/**
 * 
 * @author sadabala Create phone case for de locale
 */

public class CreatePhoneCaseForDELocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForDELocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for de locale", groups = { "Regression", "Sanity",
			"Production_Phone_3.30PM" })
	@Description("Create phone case for de locale")
	public void verifyGetCallOptionIsEnabled(ITestContext context) throws InterruptedException {
		...
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "de"));
