...
/**
 * 
 * @author sadabala Create email case for NEDERLAND locale
 */

public class EAHelpEmailCaseForNLLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForNLLocaleTest.class);

	@Test(description = "Verify the creation of Email case for NEDERLAND locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for NEDERLAND locale")
	public void verifyEmailCaseCreation(ITestContext context) throws InterruptedException {
		...
		// load EAHELP
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "nl"));
