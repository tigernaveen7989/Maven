...
public class CreateChatCaseForDELocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForDELocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for German (de-de) locale ", groups = { "Regression", "Sanity",
			"Production_Chat_3.30PM" })
	@Description("Create chat case for German (de-de) locale")
