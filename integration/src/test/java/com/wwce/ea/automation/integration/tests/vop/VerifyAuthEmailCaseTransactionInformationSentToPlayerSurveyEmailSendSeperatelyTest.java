 ...
 *
 */
public class VerifyAuthEmailCaseTransactionInformationSentToPlayerSurveyEmailSendSeperatelyTest extends VOPIntegrationBaseTest{

	@Test(description = "Verify The Auth Email Transaction Information Sent To Player Survey Email Send Seperately", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Transaction Information Sent To Player Survey Email Send Seperately")
	public void VerifyAuthEmailCaseTransactionInformationSentToPlayerSurveyEmailSendSeperatelyTest(ITestContext context) throws Exception {
