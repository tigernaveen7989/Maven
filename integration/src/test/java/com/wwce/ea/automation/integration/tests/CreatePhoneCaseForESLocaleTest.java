...
/**
 * 
 * @author sadabala Create phone case for es (SPAIN) locale
 */

public class CreatePhoneCaseForESLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForESLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for es (SPAIN) locale", groups = { "Regression", "Sanity",
			"Production_Phone_3.30PM" })
	@Description("Create phone case for es (SPAIN) locale")
