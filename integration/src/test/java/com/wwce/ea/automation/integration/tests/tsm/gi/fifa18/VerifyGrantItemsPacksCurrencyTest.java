 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Grant Items, pack, Currency for Fifa 18, for FUT and WC Game modes
 * 
 */
...
public class VerifyGrantItemsPacksCurrencyTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verify Grant, Items and Currency for fifa 18", groups = { "Regression", "Sanity" })
	@Description("Verify Grant, Items and Currency for fifa 18")
	public void verifyGrantItemsPacksCurrencyTest(ITestContext context) throws InterruptedException {
		...
		testID = "53420, 53421, 53422";
		context.setAttribute("testcase_id", testID);
		logger.info("Verify Grant, Items and Currency for fifa 18" + testID);
