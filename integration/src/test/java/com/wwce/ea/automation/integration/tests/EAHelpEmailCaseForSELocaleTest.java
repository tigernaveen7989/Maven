...
/**
 * 
 * @author sadabala Create email case for SVERIGE locale
 */

public class EAHelpEmailCaseForSELocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForSELocaleTest.class);

	@Test(description = "Verify the creation of Email case for SVERIGE locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for SVERIGE locale")
	public void verifyEmailCaseCreation(ITestContext context) throws InterruptedException {
		...
		// load EAHELP
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "se"));
