...
/**
 * 
 * @author sadabala Create phone case for JP(Janpanes) locale
 */

public class CreatePhoneCaseForJPLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForJPLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for JP(Janpanes) locale", groups = { "Regression", "Sanity","Production_Phone_7.30PM" })
	@Description("Create phone case for JP(Janpanes) locale")
