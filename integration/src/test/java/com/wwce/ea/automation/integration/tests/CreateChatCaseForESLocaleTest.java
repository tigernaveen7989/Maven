...
public class CreateChatCaseForESLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForESLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for ESPANA locale ", groups = { "Regression", "Sanity",
			"Production_Chat_5.30PM" })
	@Description("Create chat case for ESPANA locale")
