...
public class VeriftyProductLoadingAfterChatCaseTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VeriftyProductLoadingAfterChatCaseTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for ENGLISH locale ", groups = { "Regression", "Sanity"})
