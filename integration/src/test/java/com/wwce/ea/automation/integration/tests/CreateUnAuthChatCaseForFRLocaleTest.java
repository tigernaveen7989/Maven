...
public class CreateUnAuthChatCaseForFRLocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth chat case for FR locale", groups = { "Regression", "Sanity" })
