...
public class CreateUnAuthPhoneCaseForFRLocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth phone case for FR Locale", groups = { "Regression", "Sanity" })
