...
public class VerifyUnAuthEmailCaseResolvedStatusFromSameAdvisorInHouseSurveyLink extends VOPIntegrationBaseTest {

	@Test(description = "Verify The UnAuth Email Resolved Status From Same Advisor In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The UnAuth Email Resolved Status From Same Advisor In House Survey")
	public void VerifyUnAuthEmailCaseResolvedStatusFromSameAdvisorInHouseSurveyCaseTest(ITestContext context) throws InterruptedException {
