 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Account Basic info of the player.
 * 
 */
public class VerifyAccountBasicInfoTest extends TSMIntegrationBaseTest {

	public static Logger logger = Logger.getLogger(VerifyAccountBasicInfoTest.class);

	@Test(description = "Verfiy Account Basic info ", groups = { "Regression", "Sanity" })
	@Description("Verfiy Account Basic info ")
	public void verifyAccountbasicinfo(ITestContext context) throws InterruptedException {
		...
		logger.info("verify Account Basic info Test " + testID);
