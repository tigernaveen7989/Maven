...
/**
 * 
 * @author sadabala Create phone case for RU(RUSSIAN) locale
 */

public class CreatePhoneCaseForRULocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForRULocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for RU(RUSSIAN) locale", groups = { "Regression", "Sanity",
			"Production_Phone_3.30PM" })
	@Description("Create phone case for RU(RUSSIAN) locale")
