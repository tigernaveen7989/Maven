...
public class EAHelpEmailCaseForArLocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case for AR locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Verify the creation of Email case for AR locale")
	public void verifyEmailCaseCreation(ITestContext context) throws InterruptedException {
		...
		// creating emil case
		caseNumber = eaHelpChannelSelectionPage.createAuthCase(testData, CaseType.email);
