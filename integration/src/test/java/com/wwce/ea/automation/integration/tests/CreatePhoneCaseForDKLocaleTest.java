...
/**
 * 
 * @author sadabala Create phone case for dk(DENMARK) locale
 */

public class CreatePhoneCaseForDKLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForDKLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for dk(DENMARK) locale", groups = { "Regression", "Sanity" })
	@Description("Create phone case for dk(DENMARK) locale")
	public void verifyGetCallOptionIsEnabled(ITestContext context) throws InterruptedException {
		...
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "dk"));
