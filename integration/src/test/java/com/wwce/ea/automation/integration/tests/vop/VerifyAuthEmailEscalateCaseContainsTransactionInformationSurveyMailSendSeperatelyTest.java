 ...
 * reset password
 * escalate the case to other queue
 * login using different advisor 
 * Close the case to Resolved Status
 * Login into Gmail
 * survey email send seperately
 * @author Naveen Kumar
 */
public class VerifyAuthEmailEscalateCaseContainsTransactionInformationSurveyMailSendSeperatelyTest extends VOPIntegrationBaseTest{

	@Test(description = "Verify The Auth Email Escalate Case Contains Transaction Information Sent To Player Survey Email Send Seperately", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Escalate Case Contains Transaction Information Sent To Player Survey Email Send Seperately")
	public void VerifyAuthEmailEscalateCaseContainsTransactionInformationSurveyMailSendSeperatelyTest(ITestContext context) throws InterruptedException {
