...
public class CreateChatCaseForPLLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForPLLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for POLSKA locale ", groups = { "Regression", "Sanity"})
	@Description("Create chat case for POLSKA locale")
