...
/**
 * 
 * @author sadabala Create email case for FRANCE locale
 */

public class EAHelpEmailCaseForFRLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForFRLocaleTest.class);

	@Test(description = "Verify the creation of Email case for FRANCE locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for FRANCE locale")
