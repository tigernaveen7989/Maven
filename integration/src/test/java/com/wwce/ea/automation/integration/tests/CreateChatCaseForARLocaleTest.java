...
public class CreateChatCaseForARLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForARLocaleTest.class);
