...
public class VerifyUnAuthEmailResolvedStatusExternalEmailInmomentSurveyCaseTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Un Auth Email In Moment Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Un Auth Email In Moment Survey")
	public void VerifyAuthEmailInmomentSurveyCaseTest(ITestContext context) throws InterruptedException {
