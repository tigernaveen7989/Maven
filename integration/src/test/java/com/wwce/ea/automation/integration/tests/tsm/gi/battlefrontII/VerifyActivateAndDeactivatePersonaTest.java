 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Activate and Deactivate Persona for Battle front II.
 * 
 */
public class VerifyActivateAndDeactivatePersonaTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verify Activate and Deactivate Persona Test for Battle front II", groups = { "Regression", "Sanity" })
	@Description("Verify Activate and Deactivate Persona Test for Battle front II")
	public void verifyActivateAndDeactivatePersonaTest(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify Activate and Deactivate Persona Test for Battle front II: " + testID);
...
/*		// Create driver instance to open tsm website
		...
		assertEquals(testData.get("inactive").toString(), tsmAdditionalInfoPage.deActivatePersona(testData.get("inactive").toString()), "Verified Deactivate Persona");
		//Verify Activate Persona
		assertEquals(testData.get("active").toString(), tsmAdditionalInfoPage.activatePersona(testData.get("active").toString()), "Verified Activate Persona");
