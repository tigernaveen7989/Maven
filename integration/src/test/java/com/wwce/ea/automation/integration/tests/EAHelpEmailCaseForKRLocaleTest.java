...
public class EAHelpEmailCaseForKRLocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case for Korean (ko-ko) locale", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify the creation of Email case for Korean (ko-ko) locale")
