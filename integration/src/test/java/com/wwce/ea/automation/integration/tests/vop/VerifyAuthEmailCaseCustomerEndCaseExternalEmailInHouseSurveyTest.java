...
public class VerifyAuthEmailCaseCustomerEndCaseExternalEmailInHouseSurveyTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Case Customer Ends Case In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Case Customer Ends Case In House Survey")
	public void VerifyAuthEmailCaseCustomerEndCaseExternalEmailInHouseSurveyTest(ITestContext context) throws InterruptedException {
		...
		assertEquals(count, 0, count+" survey mail received");
