...
/**
 * 
 * @author sadabala Create phone case for nl(NEDERLAND) locale
 */

public class CreatePhoneCaseForNLLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForNLLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for nl(NEDERLAND) locale", groups = { "Regression", "Sanity" })
	@Description("Create phone case for nl(NEDERLAND) locale")
