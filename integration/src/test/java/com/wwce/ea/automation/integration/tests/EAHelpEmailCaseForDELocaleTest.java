...
public class EAHelpEmailCaseForDELocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case for German (de-de)locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Verify the creation of Email case for German (de-de) locale")
