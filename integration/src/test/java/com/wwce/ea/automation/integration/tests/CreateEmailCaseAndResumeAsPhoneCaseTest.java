...
public class CreateEmailCaseAndResumeAsPhoneCaseTest extends IntegrationBaseTest {
	...
	public void createChatCaseAndResumeItAsEmailCase(ITestContext context) throws InterruptedException {
		...
		/*
		 * // Create driver instance to open omega website this.loadNewInstance();
		 * 
		 ...
		 * testData.get("emailRoleName").toString());
		 * 
		 * // LOAD OMEGA ISNTANCE driverInstance.put("EMAIL", this.driver);
		 */
