...
public class VerifyAuthEmailResolvedStatusExternalEmailInhouseSurveyTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email In House Survey")
	public void VerifyAuthEmailResolvedStatusExternalEmailInhouseSurveyCaseTest(ITestContext context) throws Exception {
