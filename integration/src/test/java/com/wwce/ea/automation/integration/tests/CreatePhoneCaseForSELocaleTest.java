...
/**
 * 
 * @author sadabala Create phone case for se(SWEDEN) locale
 */

public class CreatePhoneCaseForSELocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForSELocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for se(SWEDEN) locale", groups = { "Regression", "Sanity",
			"Production_Phone_3.30PM" })
	@Description("Create phone case for se(SWEDEN) locale")
