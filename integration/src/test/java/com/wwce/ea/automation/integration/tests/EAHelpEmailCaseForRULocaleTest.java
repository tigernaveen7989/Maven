...
/**
 * 
 * @author sadabala Create an email case for DANMARK locale
 */

public class EAHelpEmailCaseForRULocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForRULocaleTest.class);

	@Test(description = "Verify the creation of Email case for Russain Locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case from EA Help portal for Russain Locale")
	public void verifyEmailCaseCreation(ITestContext context) throws InterruptedException {
		...
		// load EAHELP
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "ru"));
