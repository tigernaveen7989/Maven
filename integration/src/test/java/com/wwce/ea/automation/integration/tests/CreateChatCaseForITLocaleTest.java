...
public class CreateChatCaseForITLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForITLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for ITALIA locale ", groups = { "Regression", "Sanity",
			"Production_Chat_5.30PM" })
	@Description("Create chat case for ITALIA locale")
