...
public class CreateChatCaseForPTLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForPTLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for PORTUGAL locale ", groups = { "Regression", "Sanity"})
	@Description("Create chat case for PORTUGAL locale")
