...
/**
 * 
 * @author sadabala Create email case for Italia locale
 *
 */

public class EAHelpEmailCaseForITLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(EAHelpEmailCaseForITLocaleTest.class);

	@Test(description = "Verify the creation of Email case for ITALIA locale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Create email case for Italia locale")
