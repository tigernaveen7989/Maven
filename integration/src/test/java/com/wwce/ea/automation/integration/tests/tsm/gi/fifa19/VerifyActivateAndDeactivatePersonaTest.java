 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Activate and Deactivate Persona for fifa 19.
 * 
 */
public class VerifyActivateAndDeactivatePersonaTest extends TSMIntegrationBaseTest {
	...
	@Test(description = "Verify Activate and Deactivate Persona Test for fifa 19", groups = { "Regression", "Sanity" })
	@Description("Verify Activate and Deactivate Persona Test for fifa 19")
	public void verifyActivateAndDeactivatePersonaTest(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify Activate and Deactivate Persona Test for fifa 19: " + testID);
