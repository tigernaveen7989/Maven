 ...
 *
 */
public class VerifyUnAuthChatCaseCloseAndTransferInHouseSurveyCaseTest extends VOPIntegrationBaseTest {

	@Test(description = "Validate InHouse Survey window when transfer and close", groups = {
			"Regression", "Sanity" })
	@Description("Validate InHouse Survey window when transfer and close.")
	public void verifyAuthChatCaseAndTransferCaseTest(ITestContext context) throws Exception {
		...
		omegaSaveCaseConfirmationPage.clickOnYesFromActiveChatSessionPopup();
