 ...
 * 
 * @author rgandham
 * @description This Test is to Verify Auth No Chat channel in EAHelp ICR page.
 *              
 */

public class VerifyAuthNoChatChannelTest extends TSMIntegrationBaseTest {
	
	public static Logger logger = Logger.getLogger(VerifyAuthNoChatChannelTest.class);

	@Test(description = "Verify Auth No Chat channel", groups = { "Regression", "Sanity" })
	@Description("Verify Auth No Chat channel")
	public void verifyAuthChatchannelDeflectionMessage(ITestContext context) throws InterruptedException {
		...
		logger.info("Verify Auth No Chat channel" + testID);
