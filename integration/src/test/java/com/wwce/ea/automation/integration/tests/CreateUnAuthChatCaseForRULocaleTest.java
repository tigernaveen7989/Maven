...
public class CreateUnAuthChatCaseForRULocaleTest extends IntegrationBaseTest {

	@Test(description = "Create unauth chat case for RU locale", groups = { "Regression", "Sanity" })
	...
	public void verifyUnAuthUserNotRedirectedToLoginPage(ITestContext context) throws InterruptedException {
		...
		eaHelpUnAuthCaseInformationPage.submitUnAuthLoginForm(testData.get("unAuthEmail").toString());
