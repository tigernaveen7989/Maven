...
public class VerifyAuthEmailCasePlayerReceiveInMomentSurveyForAllInteractionOfSameCaseTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Case Player Receive In Moment Survey For All Interaction Of Same Case", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Case Player Receive In Moment Survey For All Interaction Of Same Case")
	public void VerifyAuthEmailCasePlayerReceiveInMomentSurveyForAllInteractionOfSameCaseTest(ITestContext context) throws Exception {
