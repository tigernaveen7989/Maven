...
public class CreateChatCaseForDKLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreateChatCaseForDKLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create chat case for DENMARK locale ", groups = { "Regression", "Sanity" })
	@Description("Create chat case for DENMARK locale")
