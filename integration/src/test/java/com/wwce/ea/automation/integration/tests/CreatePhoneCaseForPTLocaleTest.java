...
/**
 * 
 * @author sadabala Create phone case for pt(PORTUGAL) locale
 */

public class CreatePhoneCaseForPTLocaleTest extends IntegrationBaseTest {

	public static Logger logger = Logger.getLogger(CreatePhoneCaseForPTLocaleTest.class);
	Map<String, WebDriver> mDriverInstance = new HashMap<String, WebDriver>();

	@Test(description = "Create phone case for pt(PORTUGAL) locale", groups = { "Regression", "Sanity" })
	@Description("Create phone case for pt(PORTUGAL) locale")
	public void verifyGetCallOptionIsEnabled(ITestContext context) throws InterruptedException {
		...
		eaHelpLoginPage.loadEAHelp(IntegrationDataConstants.INTEGRATION_EAHELP_AUT_URL.replace("en", "pt"));
