...
/**
 * This class is to create email case for Japanese locale
 * 
 * @author sadabala
 *
 */

public class EAHelpEmailCaseForJPLocaleTest extends IntegrationBaseTest {

	@Test(description = "Verify the creation of Email case for Japanese ocale", groups = { "Regression", "Sanity",
			"Production_Email" })
	@Description("Verify the creation of Email case for Japanese  locale")
