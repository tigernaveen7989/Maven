...
public class VerifyAuthEmailCaseChangeToResolvedStatusFromEscalatedStatusInHouseSurveyLinkTest extends VOPIntegrationBaseTest {

	@Test(description = "Verify The Auth Email Case Change To Resolved Status From Escalated Status In House Survey", groups = { "Regression",
			"Sanity", "Production_Email" })
	@Description("Verify The Auth Email Case Change To Resolved Status From Escalated Status In House Survey")
	public void VerifyAuthEmailCaseChangeToResolvedStatusFromEscalatedStatusInhouseSurveyCaseTest(ITestContext context) throws InterruptedException {
